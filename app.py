...
DAY_SWITCH_PAUSE_SECONDS = int(
    os.environ.get(
        ...
        str(int(float(os.environ.get("DAY_SWITCH_PAUSE_MINUTES", "20")) * 60))
    )
)
...
Mögliche Einstiege: „Heute geht es um das Thema Stressbewältigung. Mich interessiert dabei besonders, wie du persönlich mit anstrengenden oder belastenden Situationen umgehst, da das Thema viele Menschen beschäftigt.“
...
INITIAL_ASSISTANT_MESSAGES = {
    ...
    4: "Willkommen zur heutigen Gesundheitsreflexion. Nach der Auseinandersetzung mit Erholung und Schlaf wird Dankbarkeit nun als weiterer möglicher Faktor psychischer Gesundheit thematisiert. Mit welcher Stimmung kommst Du heute in unsere Reflexion?",

    5: """Hallo, wir haben in den letzten vier Tagen verschiedenste Themen aus dem Bereich Psyche und Gesundheit reflektiert. Dabei konntest du vielleicht den ein oder anderen Gedanken für Deinen persönlichen Alltag mitnehmen. Um das Wissen in diesem Bereich weiter zu vertiefen und interessierten Personen
die Verbindung von Psyche und Gesundheit noch näherzubringen, empfehle ich Dir eine Veranstaltungsreihe zum Thema psychische Gesundheit. Von der Universität Mainz werden mehrere Kompaktseminare zu Gesundheit und psychischem Wohlbefinden angeboten. Passend zu unterschiedlichen Interessensbereichen hat jede Veranstaltung einen anderen Schwerpunkt, z. B. psychische Belastung am Arbeitsplatz, Stressmanagement oder Bewegung & Psyche. Die Kursdauer variiert zwischen ein und zwei Tagen. Die Kurse finden sowohl in Präsenz als auch online statt.
...
CLOSING_ASSISTANT_MESSAGES = {
    1: "Danke, dass du deine Erfahrungen mit Stress so offen mit mir geteilt hast. Damit sind wir am Ende unseres heutigen Gesprächs angekommen. Ich freue mich auf morgen.",
    2: "Vielen Dank für deine offenen Rückmeldungen zum Thema Entspannung und Entspannungsmethoden. Damit sind wir am Ende unseres heutigen Gesprächs angekommen. Bis morgen.",
    3: "Vielen Dank für Deine Offenheit und Deine Teilnahme heute. Sich mit dem eigenen Schlaf und den eigenen Bedürfnissen auseinanderzusetzen, kann ein erster wichtiger Schritt sein. Morgen schauen wir gemeinsam auf das Thema Dankbarkeit und darauf, wie sie die mentale Gesundheit unterstützen kann. Damit sind wir am Ende unseres heutigen Gesprächs angekommen. Bis morgen.",
    4: "Danke für das heutige Gespräch und Deine Offenheit. Ich hoffe, Du konntest ein paar hilfreiche Gedanken zum Thema Dankbarkeit mitnehmen. Damit sind wir am Ende unseres heutigen Gesprächs angekommen. Bis morgen."
}
