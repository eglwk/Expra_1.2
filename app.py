...
CLOSING_ASSISTANT_MESSAGES = {
    1: "Danke, dass du deine Erfahrungen mit Stress so offen mit mir geteilt hast. Ich habe den Eindruck, dass wir heute einen guten Einblick in deine aktuelle Situation bekommen haben. Damit sind wir am Ende unseres heutigen Gesprächs angekommen. Ich freue mich auf morgen.",
    2: "Danke dir für deine Offenheit. Ich hatte viel Freude dabei, gemeinsam Deinen Umgang mit Entspannungsmethoden unter die Lupe zu nehmen, und hoffe, dass ich Dir ein paar Impulse für zukünftige Entspannung im Alltag mitgeben konnte. Damit sind wir am Ende unseres heutigen Gesprächs angekommen. Bis morgen.",
